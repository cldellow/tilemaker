...
function way_function()
	...
	if highway~="" then
		...
		if minzoom <= 14 then
			...
			if access=="private" or access=="no" then Attribute("access", "no") end
			if pavedValues[surface] then Attribute("surface", "paved") end
			if unpavedValues[surface] then Attribute("surface", "unpaved") end
			...
			if Holds("mtb:scale") then Attribute("mtb_scale", Find("mtb:scale")) end
